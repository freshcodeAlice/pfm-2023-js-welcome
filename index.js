...
1. Дано два масива: [1, 2, 3] і [4, 5, 6]. Об'єднати їх разом

2. Даний масив [6, 5, 4]. Зробити з нього [4, 5,6]

3. Даний масив [1, 2, 3]. Додати йому в кінець елементи 4, 5, 6

4. Даний масив [7, 8, 9]. Додати йому на початок 1, 2, 3

5. Даний масив ['aaa', 'bbb', 'ccc']. Виведіть в консоль перший елемент та видаліть його.

6.  Даний масив ['aaa', 'bbb', 'ccc']. Виведіть в консоль та видаліть останній елемент

7. Даний масив [9, 10, 11, 12, 13]. Скопіювати в новий масив елементи з другого по п'ятий

8. З масиву [1, 2, 3, 4, 5] зробити масив [1, 4, 5] (оригінальний має змінитись)

9. З масиву [1, 2, 3, 4, 5] скопіювати в новий масив [3, 4, 5]
